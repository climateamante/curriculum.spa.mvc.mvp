define(function(){
    ...
    // Function for grabbing the currently logged in users key/value data and loading them into a dropdown to display on the logged in page. Refreshes in realtime.
