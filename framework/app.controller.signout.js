      define(function(){
        ...
        // Checks the users status and if logged in, it signs the user out using firebases signOut() method. Returns the users status afterwards and displays it on the page.

          App.prototype.controller.signout = function(){
            ...
            if( typeof(current_user()) === 'object' ){
             ...
             firebase.auth().signOut().then(
              ...
              return {
                app_controller_signout : App.prototype.controller.signout
              };
      });
